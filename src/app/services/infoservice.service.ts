...
export class InfoService {
    private docsysUrl = 'http://info.ytmt.co.th/api/documents';
    private docsysPlant = "http://info.ytmt.co.th/api/documents/plant";
    private docsysSection = "http://info.ytmt.co.th/api/documents/section";
    private docsysType = "http://info.ytmt.co.th/api/documents/type";
    ...
    requestDocument(plant: any, section: any, type: any) {
